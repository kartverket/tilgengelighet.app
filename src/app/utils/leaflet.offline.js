...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('leaflet')) :
    typeof define === 'function' && define.amd ? define(['exports', 'leaflet'], factory) :
      (global = global || self, factory(global.LeafletOffline = {}, global.L));
        ...
        var successCallback = async function () {
          ...
          try {
            for (var i = 0; i < tiles.length; i++) {
              ...
              if (cancelState) {
                cancelState = false
                console.log('Kansellerer nedlasting');
                break;
              }
              ...
              if (i > 0 && i % this$1.options.queueLimit === 0) {
               cancelPromise =  Promise.all(promises);
                var result = await cancelPromise
                  //cancelPromise = null

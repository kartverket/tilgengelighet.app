...
export const friluftGapahukHytteRullestolEl = (
  ...
  const props = {
    ...
    partlyAccessible: {
      terskel: rampe === 'Ja' && terskelHoyde >= 2.6 && terskelHoyde <= 10,
    },
    notAccessible: {
      breddeinngang: breddeinngang < 86,
      diameter: diameter < 150,
...
export const tettstedInngangByggRullestol = (
  ...
  const props = {
    accessible: {
      ...
      avstandHC:
        (avstandHC < 50 && avstandvanligparkering <= avstandHC) ||
    ...
    partlyAccessible: {
      avstandHC: avstandHC >= 50 || avstandHC > avstandvanligparkering,
      dorapner:
        dorapner === 'Manuell' ||
        (dorapner === 'Halvautomatisk' && manoverknapphoyde < 80) ||
        (dorapner === 'Halvautomatisk' &&
          manoverknapphoyde >= 120 &&
          manoverknapphoyde <= 130),
      atkomstveiStigning:
    ...
    notAccessible: {
      horisontaltFelt: horisontaltFelt < 150,
      manoverknapphoyde: manoverknapphoyde > 130,
      inngangBredde: inngangBredde < 86,
      terskelHoyde: terskelHoyde > 2.5,
...
export const tettstedInngangByggRullestolEl = (
  ...
  const props = {
    accessible: {
      rampe:
        rampe === 'Ja'
          ...
          : true,
      horisontaltFelt: horisontaltFelt >= 150,
      dorapner: dorapner === 'Automatisk' || dorapner === 'Halvautomatisk',
      dorapnerHoyde: dorapnerHoyde >= 80 && dorapnerHoyde <= 120,
      inngangBredde: inngangBredde >= 86,
      terskelHoyde: terskelHoyde <= 2.5,
    ...
    notAccessible: {
      horisontaltFelt: horisontaltFelt < 150,
      dorapnerHoyde: dorapnerHoyde > 130,
      inngangBredde: inngangBredde < 86,
